...
import kampany from '../../assets/kampanj.webp';
import bgImage from '../../assets/bg-kampanj.webp';
...
export default function Kampanj() {
  return (
    <div className=" p-8  mb-6 flex justufy-center flex-col mx-auto rounded-lg shadow-lg" style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <Button className="mt-4 mx-auto bg-orange-500 text-white hover:bg-orange-600 px-6 py-2 rounded-xl font-semibold text-lg">Se alla deals</Button>
    </div>
  )
}
