...
import { Link } from 'react-router-dom';
    ...
    return (
        <Link to={url} className="p-4 flex flex-col rounded-lg hover:shadow-md transition-shadow cursor-pointer w-[200px] min-w-[200px] bg-white border border-gray-200 hover:border-orange-300 hover:scale-105 transition-transform">
